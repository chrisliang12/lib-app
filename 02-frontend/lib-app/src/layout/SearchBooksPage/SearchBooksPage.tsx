...
export const SearchBooksPage = () => {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      ...
      const responseData = resJson._embedded.books;
        ...
        <div className="row mt-5">
          ...
          <div className="col-4">
            <div className="dropdown">
              <button className="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenueButton1" data-bs-toggle="dropdown" aria-expanded="false" >
                {categorySelection}
              </button>
